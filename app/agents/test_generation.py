...
_INVESTIGATOR_INSTRUCTION = (
    ...
    "STEP 3 — OUTPUT a test specification in this exact format:\n"
    "  CVE: <cve-id>\n"
    "  PACKAGE: <group:artifact>\n"
    "  CWE: <cwe-id and name>\n"
    "  VULNERABLE CLASS: <class that was fixed>\n"
    "  ATTACK: <what the attacker sends>\n"
    "  ASSERTION: <what the test should check>\n"
    "  TEST PATH: src/test/java/<package>/cve/Cve<YYYYNNNNN>ReproducerTest.java\n"
